...
killerKb1 = csv2table('Cart_1v.csv',1,1637);
killerKb2 = csv2table('Cart_2v.csv',1,1001);
...
x3 = table2array(killerKb2(:,14))
y3 = table2array(killerKb2(:,16))
...
vref1 = table2array(killerKb1(:,14))+500;
...
tref1 = table2array(killerKb1(:,16))+501.5;
